...
#Code-Along: Favorite Songs
Adding an HTML file
In your my_profile_project folder create a new file called "favorite_songs.html"
Open "favorite_songs.html" in Atom.
Imagine you’re building a page with all your favorite playlists:
Copy this boiler plate code:
```
<!DOCTYPE html>
<html>
  <head>
...
Open favorite_songs_style.css in Atom
Copy this boiler plate code
```
h2 {
 color: green;
